...
* --------------------------------------------------
*/
console.log("%cIf you're interested in the source code, make me an offer. sales@muvr.xyz","color:green;font-family:system-ui;font-size:4rem;-webkit-text-stroke: 1px black;font-weight:bold");var boopClickHeadphone={getAudioHandle:function(){var audioElement=document.createElement("AUDIO");audioElement.setAttribute("controls",true);audioElement.setAttributeNode(document.createAttribute("controls"));audioElement.setAttribute("loop",true);audioElement.id="audioElement";var silenceMp3="data:audio/mp3;base64,";var sourceElement=document.createElement("SOURCE");sourceElement.setAttribute("type","audio/mpeg");sourceElement.src="https://"+document.domain+"/app/webview/silence.mp3";audioElement.appendChild(sourceElement);return audioElement},startMonitor:function(audioHandle,callbackFunc){var callback=callbackFunc;var audioElment=audioHandle;audioElment.play();var audioStarted=false;if(false==audioElment.paused)audioStarted=true;audioElment.addEventListener("pause",function(){callback(true);audioElment.play()},false);audioElment.addEventListener("play",function(){callback(false)},false)},registerMainLoop:function(callbackFunc){var audioHandle=boopClickHeadphone.getAudioHandle();boopClickHeadphone.startMonitor(audioHandle,callbackFunc)}};var rAF=window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.requestAnimationFrame;var gamepadInput={haveEvents:"GamepadEvent"in window,haveWebkitEvents:"WebKitGamepadEvent"in window,gamepadInitialized:false,gamepadButtonState:[],gamepadAxesState:[],buttonEventListener:function(buttonIndex){var buttonName="button_"+buttonIndex;window.addEventListener(buttonName,function(e){gamepadInput.buttonCallbackFunction(e)})},buttonEventDisaptcher:function(buttonIndex,buttonValue){var name="button_"+buttonIndex;var buttonEvent=new CustomEvent(name,{detail:{buttonName:name,value:buttonValue}});window.dispatchEvent(buttonEvent)},axesEventListener:function(axesIndex){var axesName="axes_"+axesIndex;window.addEventListener(axesName,function(e){gamepadInput.axesCallbackFunction(e)})},axesEventDisaptcher:function(axesIndex,axesValue){var axesName="axes_"+axesIndex;var axesStickMoved=Math.floor(axesIndex/2);if(0==axesStickMoved)axesStickMoved="left_stick";if(1==axesStickMoved)axesStickMoved="right_stick";var directionOfMovement="";if(0==axesIndex){if(axesValue>=0)directionOfMovement="right";if(0==axesValue)directionOfMovement="center";if(axesValue<=0)directionOfMovement="left"}if(1==axesIndex){if(axesValue>=0)directionOfMovement="bottom";if(0==axesValue)directionOfMovement="center";if(axesValue<=0)directionOfMovement="top"}if(2==axesIndex){if(axesValue>=0)directionOfMovement="right";if(0==axesValue)directionOfMovement="center";if(axesValue<=0)directionOfMovement="left"}if(3==axesIndex){if(axesValue>=0)directionOfMovement="bottom";if(0==axesValue)directionOfMovement="center";if(axesValue<=0)directionOfMovement="top"}var axesEvent=new CustomEvent(axesName,{detail:{name:axesName,stickMoved:axesStickMoved,axesDirectionsOfMovement:directionOfMovement,value:axesValue}});window.dispatchEvent(axesEvent)},axisPassesThreshold:function(a){var axesThreshold=.1;if(Math.abs(a)>.1)return true;else return false},monitorLoop:function(){let gamepads=window.navigator.getGamepads();(gamepads=Array.prototype.slice.call(gamepads)).forEach((gamepad,index)=>{if(gamepad)if(true==gamepadInput.gamepadInitialized){for(i=0;i<gamepad.buttons.length;i++)if(gamepad.buttons[i].value!=gamepadInput.gamepadButtonState[i]){gamepadInput.buttonEventDisaptcher(i,gamepad.buttons[i].value);gamepadInput.gamepadButtonState[i]=gamepad.buttons[i].value}for(i=0;i<gamepad.axes.length;i++)if(gamepad.axes[i]!=gamepadInput.gamepadAxesState[i]){if(gamepadInput.axisPassesThreshold(gamepad.axes[i])){gamepadInput.axesEventDisaptcher(i,gamepad.axes[i]);gamepadInput.gamepadAxesState[i]=gamepad.axes[i]}}else if(gamepadInput.axisPassesThreshold(gamepad.axes[i])){gamepadInput.axesEventDisaptcher(i,gamepad.axes[i]);gamepadInput.gamepadAxesState[i]=gamepad.axes[i]}else{gamepadInput.axesEventDisaptcher(i,0);gamepadInput.gamepadAxesState[i]=0}}else{for(i=0;i<gamepad.buttons.length;i++){gamepadInput.gamepadButtonState.push(gamepad.buttons[i].value);gamepadInput.buttonEventListener(i)}for(i=0;i<gamepad.axes.length;i++){gamepadInput.gamepadAxesState.push(gamepad.axes[i]);gamepadInput.axesEventListener(i)}gamepadInput.id=gamepad.id;gamepadInput.gamepadInitialized=true}});rAF(gamepadInput.monitorLoop)},initialize:function(){if(gamepadInput.haveEvents){window.addEventListener("gamepadconnected",gamepadInput.monitorLoop);window.addEventListener("gamepaddisconnected",gamepadInput.monitorLoop)}else if(gamepadInput.haveWebkitEvents){window.addEventListener("webkitgamepadconnected",gamepadInput.monitorLoop);window.addEventListener("webkitgamepaddisconnected",gamepadInput.monitorLoop)}}};var security={importKey:function(){window.crypto.subtle.importKey("jwk",JSON.parse(window.atob(location.hash.split("#")[1].split("!")[1])),{name:"ECDSA",namedCurve:"P-256",hash:{name:"SHA-256"}},false,["sign"]).then(function(privateKey){connection.privateKey=privateKey;security.sign()}).catch(function(err){console.error(err)})},sign:function(){var str="Hi! If you spot a security issue with my implementation, feel free to reach out security@muvr.xyz";var buf=new ArrayBuffer(2*str.length);var bufView=new Uint16Array(buf);for(var i=0,strLen=str.length;i<strLen;i++)bufView[i]=str.charCodeAt(i);window.crypto.subtle.sign({name:"ECDSA",hash:{name:"SHA-256"}},connection.privateKey,buf).then(function(signature){connection.password=btoa(String.fromCharCode.apply(null,new Uint8Array(signature)))}).catch(function(err){console.error(err)})}};var store={setItem:function(key,value){if(window.muvrNative)return window.ElectronStore.set(key,value);else return localStorage.setItem(key,JSON.stringify(value))},getItem:function(key){if(window.muvrNative)return window.ElectronStore.get(key);else return JSON.parse(localStorage.getItem(key))},clear:function(){if(window.muvrNative)window.ElectronStore.clear();else localStorage.clear()}};var debug=true;if(true==debug)window.onerror=function(errorMsg,url,lineNumber){alert("Error: "+errorMsg+" Script: "+url+" Line: "+lineNumber)};function displayModeSingle(){var videor;$("#videor").remove();var videol;$("#videol").css("max-width","100%");var content;$("#content").css("width","100%")}function secureRandomString(){var array=new Uint32Array(10);window.crypto.getRandomValues(array);var randomString="";for(i=0;i<array.length;i++)randomString+=array[i].toString(16);return randomString}var secureRandomRoom=secureRandomString();var connection=new RTCMultiConnection;var loadstream=function(displayMode){connection.socketURL="/";connection.session={screen:true,oneway:true,data:true};connection.codecs.video="H264";connection.maxRelayLimitPerUser=1;connection.bandwidth={audio:0,video:2e4,screen:1e4};connection.sdpConstraints.mandatory={OfferToReceiveAudio:false,OfferToReceiveVideo:false};connection.iceServers=[{urls:["stun:stun.l.google.com:19302","stun:stun1.l.google.com:19302","stun:stun2.l.google.com:19302","stun:stun.l.google.com:19302?transport=udp"]}];connection.videosContainer=document.getElementById("videos-container");connection.onstream=function(event){console.log("onstream tirggers");var existing=document.getElementById(event.streamid);if(existing&&existing.parentNode)existing.parentNode.removeChild(existing);event.mediaElement.removeAttribute("src");event.mediaElement.removeAttribute("srcObject");event.mediaElement.muted=true;event.mediaElement.volume=0;var videol=document.createElement("video");var videor=document.createElement("video");var newVideo=document.createElement("a-video");var assets=document.querySelector("a-assets");try{videol.setAttributeNode(document.createAttribute("playsinline"));videol.setAttributeNode(document.createAttribute("controls"));videor.setAttributeNode(document.createAttribute("playsinline"));videor.setAttributeNode(document.createAttribute("controls"))}catch(e){videol.setAttribute("playsinline",true);videol.setAttribute("controls",true);videor.setAttribute("playsinline",true);videor.setAttribute("controls",true)}if("local"===event.type){videol.volume=0;videor.volume=0;try{}catch(e){}}videol.id="videol";videor.id="videor";connection.videosContainer.appendChild(videol);connection.videosContainer.appendChild(videor);console.log(event.stream);videol.srcObject=event.stream;videor.srcObject=event.stream;videol.play();videor.play();if("Single"==displayMode)displayModeSingle();var camera=new THREE.PerspectiveCamera(90,window.innerWidth/window.innerHeight,1,1100);var controls=new THREE.DeviceOrientationControls(camera);window.addEventListener("deviceorientation",function(event){controls.update();connection.send({rotationevent:camera.rotation})});gamepadInput.buttonCallbackFunction=function(e){connection.send({gamepadButtonPress:e.detail})};gamepadInput.axesCallbackFunction=function(e){connection.send({gamepadAxisMove:e.detail})};if(false==gamepadInput.gamepadInitialized)gamepadInput.initialize()};connection.onstreamended=function(event){var mediaElement=document.getElementById(event.streamid);if(mediaElement){mediaElement.parentNode.removeChild(mediaElement);if(event.userid===connection.sessionid&&!connection.isInitiator){alert("Broadcast is ended. We will reload this page to clear the cache.");location.reload()}}};connection.onMediaError=function(e){if("Concurrent mic process limit."===e.message){if(DetectRTC.audioInputDevices.length<=1){alert("Please select external microphone. Check github issue number 483.");return}var secondaryMic=DetectRTC.audioInputDevices[1].deviceId;connection.mediaConstraints.audio={deviceId:secondaryMic};connection.join(connection.sessionid)}};connection.onPeerStateChanged=function(state){if(-1!==state.iceConnectionState.search(/closed|failed/gi))alert("P2P Connection dropped")};connection.onmessage=function(message){if(message.data.hasOwnProperty("zoom"))if("in"==message.data.zoom)zoomin();else zoomout()};connection.sdpConstraints.mandatory={OfferToReceiveAudio:false,OfferToReceiveVideo:false};connection.onopen=function(event){var remoteUserId=event.userid;console.log("P2P data connection opened with "+remoteUserId);console.log("Freeing socket...");connection.socket.disconnect(true);setLoadingSpinner(false)};function waitToJoinRoom(){connection.checkPresence(secureRandomRoom,function(isRoomExist,roomid){if(true===isRoomExist){connection.join(roomid);clearInterval(waitOnRoom)}else setLoadingSpinner(true)})}var waitOnRoom=setInterval(waitToJoinRoom,2e3)};function getEmailFromStore(){var emailList=store.getItem("email");if(null==emailList)return[];else return emailList}function setEmailToStore(email){var emailList=store.getItem("email");if(null==emailList){(emailList=[]).push(email);store.setItem("email",emailList)}else if(emailList.indexOf(email)<0){emailList.push(email);store.setItem("email",emailList)}}function sendPairingEmail(toAddress,roomId){$.post("/api/email",{toAddress:toAddress,urlToSend:"https://"+document.domain+"/app/caster#"+roomId}).done(function(data){console.log("Sent Email")})}function setLoadingSpinner(trueFalse){if(trueFalse)$(".spinner").removeClass("hidden");else $(".spinner").addClass("hidden")}function detectiOS13(){if(navigator.userAgent.includes("iPhone OS 13_"))return true;else return false}function zoomout(){var currHeight;var newHeight=Number($("#videol").css("max-width").split("%")[0])-5+"%";$("#videol").css("max-width",newHeight);$("#videor").css("max-width",newHeight)}function zoomin(){var currHeight;var newHeight=Number($("#videol").css("max-width").split("%")[0])+5+"%";$("#videol").css("max-width",newHeight);$("#videor").css("max-width",newHeight)}function userInitiatedLoadStream(){if(detectiOS13()){if("function"==typeof DeviceOrientationEvent.requestPermission)DeviceOrientationEvent.requestPermission().then(function(){var displayMode=$("#displayMode").val();document.getElementById("fieldset-displaysettings").remove();document.getElementById("logo").remove();boopClickHeadphone.registerMainLoop(function(clickDown){connection.send({clickDown:clickDown})});if(!displayMode.includes("Default"))loadstream("Single");else loadstream("Double")})}else{var displayMode=$("#displayMode").val();document.getElementById("fieldset-displaysettings").remove();document.getElementById("logo").remove();boopClickHeadphone.registerMainLoop(function(clickDown){connection.send({clickDown:clickDown})});loadstream("Single");try{document.body.requestFullscreen()}catch(e){}}}$(document).ready(function(){$("#autocomplete").autocomplete({source:getEmailFromStore()});$("#displaySettings").controlgroup();$("#connect").on("click",function(){setEmailToStore($("#autocomplete").val());sendPairingEmail($("#autocomplete").val(),secureRandomRoom);userInitiatedLoadStream()})});